...
public class StudentQC extends ActionSupport {
	...
	private Student cnbean;
	public Student getCnbean() {
		return cnbean;
	}

	public void setCnbean(Student cnbean) {
		this.cnbean = cnbean;
	}
	...
	public String execute() throws Exception {
		...
		//查询是否存在
		List<Student> list=new StudentDao().GetList("Student_Username='"+Student_Username+"' and Student_State='入住'", "");
		if(list.size()<1)
		{
